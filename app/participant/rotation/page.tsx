  ...
  return (
    <div className="min-h-screen bg-deep-green text-foreground py-8 px-4">
      <div className="max-w-2xl mx-auto">
        <h1 className="text-3xl font-bold mb-8 text-center">1, 2, 3순위 선택하기</h1>

        <form onSubmit={handleSubmit} className="space-y-6">
          {/* 1순위 */}
          <div>
            <label className="block mb-2 font-semibold">1순위</label>
            <select
              required
          ...
          {/* 2순위 */}
          <div>
            <label className="block mb-2 font-semibold">2순위</label>
            <select
              required
          ...
          {/* 3순위 */}
          <div>
            <label className="block mb-2 font-semibold">3순위</label>
            <select
              required
          ...
          {/* 하고 싶은 말 */}
          <div>
            <label className="block mb-2 font-semibold">하고 싶은 말</label>
            <textarea
