...
- SOLAPI 문자 발송 기능을 사용하려면 `SOLAPI_ENABLED=true`로 설정하고 SOLAPI 계정을 생성하여 API 키를 발급받아야 합니다.
- 문자 발송 기능을 비활성화하려면 `SOLAPI_ENABLED=false`로 설정하거나 환경 변수를 제거하세요 (기본값: 비활성화).
